...
print(sent)
sets=set(sent)
print(sets)                  #it tried to fin unique characters ,not the longest substring my mistake
curve=0
...
k=9
target={}
for i in range (len(nums)):       # 2 pass solution
    target[nums[i]]=i
print(target)
...
#now for the one based indexing
nums=[2,7,11,15]
k=9
l , r = 0 , len(nums)-1
while l<r:
